...
import { PeselInputComponent } from '@features/parser/ui/pesel-input/pesel-input.component';
import { ResultOutputComponent } from '@features/parser/ui/result-output/result-output.component';

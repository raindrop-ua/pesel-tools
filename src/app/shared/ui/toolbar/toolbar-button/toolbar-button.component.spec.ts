...
import {
  ActionResult,
  ToolbarAction,
} from '@shared/ui/toolbar/toolbar-button/toolbar-action';
...
describe('ToolbarButtonComponent', () => {
  ...
  function setupInputs(
    ...
    (component as unknown as Record<string, unknown>)['activeIcon'] = () =>
      'check';
    (component as unknown as Record<string, unknown>)['title'] = () => 'Copy';
    (component as unknown as Record<string, unknown>)['activeTitle'] = () =>
      'Copied';
